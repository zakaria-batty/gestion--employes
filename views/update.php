...
<div class="container">
    <div class="row my-4">
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">Modidier un employé</div>
                <div class="card-body bg-light">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="date_emb" class="form-control" value="<?php echo $employe->date_emb; ?>">
                        </div>
                        <div class="form-group">
                            <select class="form-control" name="statut" id="">
                                <option value="1" <?php echo $employe->statut ? 'selected' : ''; ?>>Active</option>
                                <option value="0" <?php echo !$employe->statut ? 'selected' : ''; ?>>Résilité</option>
                            </select>
                        </div>
                        <div class="form-group">
