...
class Employe
{
    //function for recover all employees
    ...
    //function for update new employe
    static public function update($data)
    {
        $stmt = DB::connect()->prepare('UPDATE employes SEt 
        nom = :nom ,prenom = :prenom ,matricule = :matricule ,depart = :depart ,poste = :poste ,date_emb = :date_emb ,statut = :statut WHERE id= :id');
    ...
    //function for delete new employe
